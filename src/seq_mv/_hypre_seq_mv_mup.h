...
HYPRE_Int
hypre_CSRMatrixComputeLevelSetsHost_flt( hypre_CSRMatrix *A, HYPRE_Int **low_set_offsets, HYPRE_Int **low_level_sets, HYPRE_Int **upp_set_offsets, HYPRE_Int **upp_level_sets, HYPRE_Int *num_low_levels, HYPRE_Int *num_upp_levels, HYPRE_Int *max_level_set_size );
HYPRE_Int
hypre_CSRMatrixComputeLevelSetsHost_dbl( hypre_CSRMatrix *A, HYPRE_Int **low_set_offsets, HYPRE_Int **low_level_sets, HYPRE_Int **upp_set_offsets, HYPRE_Int **upp_level_sets, HYPRE_Int *num_low_levels, HYPRE_Int *num_upp_levels, HYPRE_Int *max_level_set_size );
HYPRE_Int
hypre_CSRMatrixComputeLevelSetsHost_long_dbl( hypre_CSRMatrix *A, HYPRE_Int **low_set_offsets, HYPRE_Int **low_level_sets, HYPRE_Int **upp_set_offsets, HYPRE_Int **upp_level_sets, HYPRE_Int *num_low_levels, HYPRE_Int *num_upp_levels, HYPRE_Int *max_level_set_size );
